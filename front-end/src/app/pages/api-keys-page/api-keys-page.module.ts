...
@NgModule({
  declarations: [ApiKeysPageComponent, ApiKeysTableComponent, ApiKeysFormComponent, WosQuotaTableComponent, WosQuotaFormComponent, WosQuotaYearFormComponent, WosQuotaYearTableComponent],
